...
public class DrinkDatabase {
  ...
  @Table(AlcoholicColumn.class)
  public static final String NON_ALCOHOLIC = "Non_Alcoholic";

  @Table(AlcoholicColumn.class)
  public static final String COCKTAIL = "Cocktail";

  @Table(AlcoholicColumn.class)
  public static final String ORDINARY_DRINK = "Ordinary_Drink";
  ...
  @Table(AlcoholicColumn.class)
  public static final String HIGHBALL_GLASS = "Champagne_Flute";

  @Table(AlcoholicColumn.class)
  public static final String SAVED = "Drink_Saved";
