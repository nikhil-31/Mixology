...
public class DrinkTypeFilterJob extends Job {
  private static final String TAG = "DrinkTypeFilterJob";

  private Uri uri;
  private String filter;

  public DrinkTypeFilterJob(String uri, String filter) {
  ...
  public void onRun() throws Throwable {
    ...
    Call<Cocktails> listCall = service.getDrinkTypeFilter(filter);
