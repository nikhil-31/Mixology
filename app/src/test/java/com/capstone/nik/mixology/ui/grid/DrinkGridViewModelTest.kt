...
class DrinkGridViewModelTest {
    ...
    fun bind_loadsCachedFilterDrinks() = runTest {
        ...
        viewModel.state.test {
            ...
            assertEquals("Gin Fizz", loaded.drinks.single().name)
    ...
    fun toggleSaved_savesDrinkWithoutMessage() = runTest {
        ...
        viewModel.state.test {
            ...
            viewModel.effects.test {
                viewModel.onIntent(DrinkGridIntent.ToggleSaved(loaded.drinks.single()))
                expectNoEvents()
            }
        }
    ...
    @Test
    fun openDrink_emitsEffect() = runTest {
        val drink = cocktailDrink("1", "Gin Fizz").toDrink()!!
        viewModel.effects.test {
