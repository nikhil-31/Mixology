...
## Corpus Check
- 78 files · ~40,112 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 557 nodes · 864 edges · 32 communities (26 shown, 6 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 106 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b782f3a3`
...
### Community 3 - "IngredientMeasure"
Cohesion: 0.08
Nodes (26): CircularDrinkImage(), DrinkImage(), IngredientImage(), Modifier, DrinkHeroImage(), DrinkRecipeBody(), Modifier, FavoriteButton() (+18 more)
...
Cohesion: 0.17
Nodes (11): ActivityDetails, AppCompatActivity, Bundle, ActivityMain, AppCompatActivity, DrinkWidgetProvider, Context, Intent (+3 more)
...
Cohesion: 0.10
Nodes (12): Bundle, DrawerDestination, DrawerNavItem, DrawerSection, Filter, gridRoute(), Randomixer, MixologyApp() (+4 more)
...
- **Why does `Drink` connect `Drink` to `Cocktail`, `IngredientMeasure`, `DrinkDetailsViewModel`, `MixologyTheme`, `RandomixerViewModel`, `DrinkFilterTest`, `FilterKind`, `CocktailService`?**
...
- **Why does `MixologyTheme()` connect `MixologyTheme` to `IngredientMeasure`, `.onCreate`, `DrinkWidgetProvider.java`, `DrinkDetailsViewModel`, `MixologyApp`, `.onCreate`, `DrinkFilter`?**
